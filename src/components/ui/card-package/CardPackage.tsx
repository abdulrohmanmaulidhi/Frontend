...
const CardPackage = ({
  ...
  if (variant === 'compact-bookmark') {
    return (
      <div
        className={`flex flex-col w-[380px] items-start gap-[9px] pt-[19px] pb-2 px-[17px] bg-white rounded-[15px] shadow-lg ${className}`}
      >
        {/* Image Section */}
        <div className="flex flex-col w-[350px] h-48 items-start gap-2.5">
  ...
  if (variant === 'minimal-text') {
    return (
      <div
        className={`flex flex-col w-[380px] items-start gap-[9px] pt-[19px] pb-2 px-[17px] bg-white rounded-[15px] shadow-lg cursor-pointer hover:shadow-xl transition-shadow ${className}`}
        onClick={onDetailsClick}
      >
        {/* Image Section */}
        <div className="flex flex-col w-[350px] h-48 items-start gap-2.5">
  ...
  return (
    ...
    >
      ...
      {/* Content Section */}
      <div className="flex flex-col items-start justify-end self-stretch w-full flex-[0_0_auto] mb-[-5.00px]">
        {/* Title */}
        ...
        <div className="flex flex-col items-start gap-3 self-stretch w-full flex-[0_0_auto]">
          <div className="flex flex-col items-start gap-[3px] self-stretch w-full flex-[0_0_auto]">
            {/* Location and Airline Row */}
            <div className="flex items-center gap-[25px] self-stretch w-full flex-[0_0_auto]">
              {/* Location */}
              {showLocation && (
                <div className="flex w-[195px] items-start">
                  <div className="inline-flex items-start gap-2.5 px-2 py-2.5 flex-[0_0_auto]">
                    <svg
                      className="w-6 h-6"
                      xmlns="http://www.w3.org/2000/svg"
                      viewBox="0 0 24 24"
                  ...
                  <div className="flex w-[165px] items-center justify-center gap-2.5 px-[13px] py-2.5 -ml-2.5">
                    <div className="flex-1 self-stretch mt-[-1.00px] font-medium text-base text-slate-600 whitespace-nowrap">
                      {country}
                    </div>
                  </div>
                </div>
              ...
              {showAirline && (
                <div className="flex items-start flex-1 grow">
                  <div className="flex items-start gap-2.5 px-0.5 py-2.5 w-[42px]">
                    <svg
                      className="w-[33.86px] h-[33.86px]"
                      xmlns="http://www.w3.org/2000/svg"
                      viewBox="0 0 34 34"
                      fill="none"
                    >
                  ...
                  <div className="h-[54px] flex items-center justify-center gap-2.5 px-[13px] py-2.5 flex-1 grow -ml-3">
                    <div className="flex-1 self-stretch font-medium text-base text-slate-600 mt-[-1.00px]">
                      {airline}
                    </div>
                  </div>
                </div>
            ...
            {/* Date Row */}
            {showDate && (
              <div className="flex items-start self-stretch w-full flex-[0_0_auto]">
                ...
                <div className="flex items-center justify-center gap-2.5 px-[13px] py-2.5 flex-1 grow -ml-3">
                  <div className="flex-1 self-stretch mt-[-1.00px] font-medium text-base text-slate-600 whitespace-nowrap">
                    {dateRange}
                  </div>
                </div>
          ...
          <div className="flex flex-col items-start gap-1 self-stretch w-full flex-[0_0_auto]">
            ...
            <div className="flex items-center gap-[87px] self-stretch w-full flex-[0_0_auto]">
              {/* Price Section */}
              <div className="flex flex-col w-[167px] items-start">
                <div className="flex items-center gap-2.5 p-2.5 self-stretch w-full flex-[0_0_auto]">
                  <div className="w-fit font-medium text-base text-[#444444] whitespace-nowrap mt-[-1.00px]">
                    {priceLabel}
                  </div>
                </div>
                <div className="flex items-center gap-2.5 p-2.5 self-stretch w-full flex-[0_0_auto] mt-[-17px]">
                  <div className="w-fit mr-[-19.00px] font-semibold text-xl text-[#444444] mt-[-1.00px]">
                    {price}
                  </div>
                </div>
              </div>
              ...
              {/* Button */}
              <Button
                className="flex w-[146px]! h-[49px]! items-center justify-center gap-2.5 p-2.5 rounded-[10px] transition-colors cursor-pointer"
                onClick={onDetailsClick}
                type="button"
                variant="light-purple-hover-dark-purple"
              >
                <span className="w-fit font-semibold text-base text-white whitespace-nowrap">
                  {buttonText}
                </span>
              </Button>
            </div>
